...
if(get_line_CONFIG_INCLUDED)
  return()
endif()
set(get_line_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(get_line_SOURCE_PREFIX /home/qianjie/Get_Line/src/get_line)
  set(get_line_DEVEL_PREFIX /home/qianjie/Get_Line/devel)
  set(get_line_INSTALL_PREFIX "")
  set(get_line_PREFIX ${get_line_DEVEL_PREFIX})
else()
  set(get_line_SOURCE_PREFIX "")
  set(get_line_DEVEL_PREFIX "")
  set(get_line_INSTALL_PREFIX /home/qianjie/Get_Line/install)
  set(get_line_PREFIX ${get_line_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'get_line' is deprecated")
...
set(get_line_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/qianjie/Get_Line/src/get_line/include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl " STREQUAL " ")
  set(get_line_INCLUDE_DIRS "")
  set(_include_dirs "/home/qianjie/Get_Line/src/get_line/include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'qianjie <qianjie@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${get_line_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'get_line' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'get_line' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/qianjie/Get_Line/src/get_line/${idir}'.  ${_report}")
    endif()
    _list_append_unique(get_line_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND get_line_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/qianjie/Get_Line/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(get_line_LIBRARY_DIRS ${lib_path})
      list(APPEND get_line_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'get_line'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND get_line_LIBRARIES ${lib})
    endif()
  endif()
...
set(get_line_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${get_line_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "pcl_ros;roscpp;sensor_msgs;std_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 get_line_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${get_line_dep}_FOUND)
      find_package(${get_line_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${get_line_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(get_line_INCLUDE_DIRS ${${get_line_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(get_line_LIBRARIES ${get_line_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${get_line_dep}_LIBRARIES})
  _list_append_deduplicate(get_line_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(get_line_LIBRARIES ${get_line_LIBRARIES})

  _list_append_unique(get_line_LIBRARY_DIRS ${${get_line_dep}_LIBRARY_DIRS})
  list(APPEND get_line_EXPORTED_TARGETS ${${get_line_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${get_line_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
